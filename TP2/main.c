...
int main(int argc, char *argv[])
{
    if (argc != 2)
    {
        fprintf(stderr, "Invalid arguments. Just call this program specifying the file: ./main <file_name>.\n");
        return 1;
    }
...
static int read_address(char *line)
{
    ...
    {
        fprintf(stderr, "Error: the address specified is bigger than the size of the main memory.\n");
        return 1;
    }
    printf("Read byte: %u\n", read_byte(address));
    return 0;
